...
class SubscriptionView extends View
{
    ...
    protected function echoBodyTemplate()
    {
        ...
        if ($strErr && strlen($strErr) > 0) {
            ...
            echo "$response<DIV style='height:150px; padding:10px 0 0 10px; font-size: 22px;' class='color_red'>$strErr</DIV>";
            return;
        }

        echo "$response<DIV style='height:150px; padding:10px 0 0 10px; font-size: 22px;'>$strInfo</DIV>";
    }
}